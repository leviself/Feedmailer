...
<html xmlns='http://www.w3.org/1999/xhtml'>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="<?php echo TEMPLATE_PATH; ?>stylesheet.css" />
	</head>
	...
	<body>
		...
		<div id="bodywrapper">
			<div id="header">
				<img class="headerimg" src="<?php echo TEMPLATE_PATH; ?>images/logo.png" alt="<?php echo SITE_TITLE; ?> Logo" title="<?php echo SITE_TITLE; ?> Logo"/>
			</div>
